...
export default function AuthModal() {
  ...
  return (
    <div className='auth-modal__container bg-neutral-dark-blue/40 min-h-screen w-full flex items-center justify-center fixed z-10 top-0 left-0'>
      <div className="auth-modal__content bg-neutral-white mx-4 py-6 px-[26px] rounded-lg max-w-[400px] md:px-8">
